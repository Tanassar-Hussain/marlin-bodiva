...
import { ChangePasswordComponent } from './modules/common-components/change-password-component/change-password-component';
...
@NgModule({
    ...
    imports: [
        ...
        TranslateModule,
        AuthSignInModule,
        UserIdleModule.forRoot({idle: AppConstants.SESSION_IDLE_SECONDS, timeout: AppConstants.SESSION_TIMEOUT_SECONDS, ping: AppConstants.SESSION_PING_SECONDS}),
        DropDownsModule
    ],
