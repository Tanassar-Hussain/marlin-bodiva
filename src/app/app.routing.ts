...
export const appRoutes: Route[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'repo',
                loadChildren: () => import('../app/modules/admin/oms/repo/repo.module').then(m => m.RepoModule)
            },
            {
                path: 'aboutUs',
                loadChildren: () => import('app/modules/auth/sign-in/sign-in.module').then(m => m.AuthSignInModule)
            ...
            {
                path: 'orders',
                loadChildren: () => import('app/modules/admin/oms/orders/orders.module').then(m => m.OrdersModule)
            },
