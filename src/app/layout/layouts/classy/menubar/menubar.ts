...
export class Menubar implements OnInit {
  ...
  constructor(el: ElementRef, public userService: AuthService2,
    ...
    if (this.claims.user.userType == "PARTICIPANT" || this.claims.user.userType == "PARTICIPANT ADMIN" || this.claims.user.userType == "PARTICIPANT OPERATOR") {
      this.showDashbaordBO = true
    }

    if ((AppConstants.userType === AppConstants.USER_TYPE_CLIENT_CODE) && (AppUtility.isValidVariable(AppConstants.participantId))) {
