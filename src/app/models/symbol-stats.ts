...
export class SymbolStats
{
    ...
    {   
        ...
        this.average_price = Number(symbolStats.average_price);
        this.last_day_close_price = Number(symbolStats.last_day_close_price);
        this.last_trade_price = Number(symbolStats.last_trade_price);
        this.open = Number(symbolStats.open);
        this.high = Number(symbolStats.high);
        this.low = Number(symbolStats.low);
        ...
        this.net_change = Number(symbolStats.net_change);
    }
