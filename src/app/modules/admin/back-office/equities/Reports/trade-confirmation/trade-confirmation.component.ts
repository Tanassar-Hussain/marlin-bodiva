  ...
  public printReport(model: any, isValid: boolean) {
    ...
    if(this.email){
      this.reportService.getClientLastActivityWithEmail(this.params.PARTICIPANT_ID, startDate, endDate, this.params.EXCHANGE_ID,
        AppConstants.exchangeCode, AppConstants.ALL_VAL, AppConstants.ALL_STR, encodeURIComponent(this.params.FROM_ACCOUNT.valueOf()),
        encodeURIComponent(this.params.TO_ACCOUNT.valueOf()), AppConstants.ALL_VAL, AppConstants.ALL_STR, AppConstants.ALL_VAL, AppConstants.ALL_STR, this.lang)
        .subscribe(
          restData => {
            this.loader.hide();
            var reportData: any;
      ...
      this.reportService.getTradeConfirmation(this.params.PARTICIPANT_ID, this.params.MARKET_ID, this.params.ASSET_ID, startDate, endDate, this.params.EXCHANGE_ID, encodeURIComponent(this.params.FROM_ACCOUNT.valueOf()), encodeURIComponent(this.params.TO_ACCOUNT.valueOf()), this.lang)
        .subscribe(
          restData => {
            this.loader.hide();
            this.appState.showLoader = false;
