...
import { ProcessCouponPaymentComponent } from './process-coupon-payemnt/process-coupon-payment';
import { WaterFallTicker } from './waterfall ticker/waterfall-ticker';
import { RepoTrade } from './Reports/repo-trade/repo-trade';
...
export const EquitiesRoutingModule: Route[] = [
    ...
    {
        path: 'waterfall-ticker',
        component: WaterFallTicker,

    },
    {
        path: 'process-coupon-payment',
        component: ProcessCouponPaymentComponent,
    },
    {
