 ...
 *********************************/
  ...
  public printReport(model: any, isValid: boolean) {
    ...
    if (isValid) {
      this.loader.show();
      this.listingService.getClientListRpt(AppConstants.participantId, this.params.END_DATE,this.lang , this.reportType)
        .subscribe(
        restData => {
          this.loader.hide();
          var reportData: any;
          ...
          if(reportData.contentType === 'application/csv'){
            this.pdf = false;
