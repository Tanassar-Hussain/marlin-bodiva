...
@Component({
  selector: 'clients-holding-page',
  templateUrl: './clients-holding-page.html',
})

export class ClientsHoldingPage implements OnInit {
  public myForm: FormGroup;
  errorMessage: string;
  //claims: any;
  exchangeList: any[] = [];
  exchangeSelected: number = AppConstants.exchangeId;
  ...
  public clearFields() {
    ...
    this.exchangeSelected = AppConstants.exchangeId;
