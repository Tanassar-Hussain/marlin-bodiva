...
export class CdcReconcilation implements OnInit {
  ...
  public pdfFields = [
    ...
    { label: 'CDC Code', value: '' },
    { label: 'Client Code', value: '' },
    { label: 'Name', value: '' },
    { label: 'CDC Holding', value: '' },
    { label: 'BBO Holding', value: '' },
  ...
  public btnUpload(model: any, isValid: boolean) {
    ...
    this.listingService.uploadCDCReconcilationNew(this.oCDCMigrator).subscribe(
      data => {
        ...
        this.cdcReportArray = data.cdcList;
  ...
  generatePDFCustom() {
    const docDefinition = {
      ...
      footer: function (currentPage, pageCount) {   //footer alignment by Usama Attique
        return {
          columns: [
            {
              text: { text: currentPage.toString() + ' of ' + pageCount },
              alignment: 'center',
              fontSize: 10,
              margin: [0, 10, 0, 0]
            }
      ...
      content: [
        ...
        { text: 'CDC Reconcilation Report', style: 'header' },
        {
...

        {
          table: {
            ...
            body: [
              [{ text: 'Security', style: 'tableHeader' }, { text: 'CDC Code', style: 'tableHeader' }, { text: 'Client Code', style: 'tableHeader' }, { text: 'Name', style: 'tableHeader' }, { text: 'CDC Holding', style: 'tableHeader' }, { text: 'BBO Holding', style: 'tableHeader' }, { text: 'Difference', style: 'tableHeader' }, { text: 'Reason', style: 'tableHeader' }],
              ...this.cdcReportArray.map(p => [{ text: p.security, style: 'tableText' }, { text: p.cdc_code, style: 'tableText' }, { text: p.clientCode, style: 'tableText' }, { text: p.full_name, style: 'tableText' }, { text: p.cdc_holding, style: 'tableText' }, { text: p.bbo_holding, style: 'tableText' }, { text: p.difference, style: 'tableText' }, { text: p.Reason, style: 'tableText' },])
            ],
    ...
    pdfMake.createPdf(docDefinition).download('CDC Reconcilation.pdf');
