...
public getNotificationFromChild=(event)=>{
  ...
  public onNewActionShowForm = () => {  
    ...
    this.clientRegistration.isEditFields = false;
    ...
    this.clientRegistration.statusCodeForInvReg = "S";        //Added By Faizan Defect Id - 1170, 26-07-2023
    this.clientRegistration.documentForm.controls['fileUpload'].enable();
    this.clientRegistration.myForm.controls['agreeTC'].enable();
  ...
  this.loader.show();
    if (AppUtility.isEmpty(this.searchClientCode) && AppUtility.isEmpty(this.searchClientName)) {
      this.listingService.getClientListByBrokerMob(AppConstants.participantId, false)
        .subscribe(
          restData => {
            this.loader.hide();
      ...
      this.listingService.getClientListByBrokerAndClientCodeMob(AppConstants.participantId, encodeURIComponent(this.searchClientCode))
        .subscribe(
          restData => {
            this.loader.hide();
            if(!AppUtility.isValidVariable(restData)){
      ...
      this.listingService.getClientListByBrokerAndClientNameMob(AppConstants.participantId, encodeURIComponent(this.searchClientName))
        .subscribe(
          restData => {
            this.loader.hide();
            if(!AppUtility.isValidVariable(restData)){
      ...
      this.listingService.getClientListByBrokerAndClientCodeAndClientNameMob(AppConstants.participantId, encodeURIComponent(this.searchClientCode), encodeURIComponent(this.searchClientName))
        .subscribe(
          restData => {
