...
import { WelcomeNoteSetupComponent } from './welcome-note-setup/welcome-note-setup';
import { OrderLimitsComponent } from './order-limits/order-limits.component';
import { AddUpdateOrderLimitComponent } from './order-limits/add-update-order-limit/add-update-order-limit.component';
...
@NgModule({
  declarations: [
    ...
    ClientRegistration,
    CurrencyRates,
    WelcomeNoteSetupComponent,
    OrderLimitsComponent,
    AddUpdateOrderLimitComponent
  ],
  imports: [
