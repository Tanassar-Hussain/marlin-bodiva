 ...
 *********************************/
  ...
  public onEditAction() {
    ...
    if (!AppUtility.isEmpty(this.selectedItem)) {
      this.isEditing = true;
      this.selectedItem.percentage = String(this.itemsList.currentItem.percentage);
      this.selectedItem.fromYear = String(this.itemsList.currentItem.fromYear);
      this.selectedItem.toYear = String(this.itemsList.currentItem.toYear);
