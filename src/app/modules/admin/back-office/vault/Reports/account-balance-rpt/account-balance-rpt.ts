...
@Component({
  ...
  selector: 'account-balance-rpt',
  templateUrl: './account-balance-rpt.html',
  encapsulation: ViewEncapsulation.None,
})
export class AccountBalanceRpt implements OnInit {
 ...
 *********************************/
  ...
  public printReport(model: any, isValid: boolean) {
    ...
    if (isValid) {
      ...
      this.reportService.accountBalanceRpt(this.params.EXCHANGE_ID, this.params.PARTICIPANT_ID, startDate, encodeURIComponent(this.params.FROM_ACCOUNT.valueOf()),
        encodeURIComponent(this.params.TO_ACCOUNT.valueOf()), this.params.SECURITY_ID, this.lang, this.reportFormat)
        .subscribe(
          restData => {
            this.loader.hide();
            ...
            else if (this.reportFormat === "CSV" || this.reportFormat === "XLS") {
               this.pdf = false;
              let reportData: any;
              reportData = restData;
