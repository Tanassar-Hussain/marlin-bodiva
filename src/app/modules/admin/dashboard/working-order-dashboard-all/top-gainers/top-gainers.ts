...
export class TopGainersComponent implements OnInit {
    ...
    getTopGainers() {
        ...
        this.listingSvc.topGainers(this.exchangeCode, this.marketCode, this.assetId, AppConstants.LIMIT_GAINERS_LOOSERS_VOLUMELEADERS , AppConstants.HISTORY_DAYS_VOLUME_LEADER).subscribe(res => {
            res.map(a => {
            ...
            this.data = res;
            this.data = this.data.sort((n1, n2) => Number(n2.changePerc) - Number(n1.changePerc));
