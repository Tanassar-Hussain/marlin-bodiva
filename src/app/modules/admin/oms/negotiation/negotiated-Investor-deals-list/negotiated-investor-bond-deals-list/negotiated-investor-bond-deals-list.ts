...
@Component({
    selector: 'negotiated-investor-bond-deals-list',
    templateUrl: './negotiated-investor-bond-deals-list.html',
})

export class NegotiatedInvestorBondDealsListComponent {
    ...
    constructor(private translate: TranslateService, public authService: AuthService2, private splash: FuseLoaderScreenService, private listingSvc: ListingService, private orderSvc: OrderService, private toast: ToastrService,) {
