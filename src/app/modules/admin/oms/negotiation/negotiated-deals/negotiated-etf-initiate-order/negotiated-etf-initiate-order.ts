...
@Component({
  selector: 'negotiated-etf-initiate-order',
  templateUrl: './negotiated-etf-initiate-order.html',
})

export class NegotiatedETFInitiateOrderComponent {
  ...
  constructor(private appState: AppState, public authService: AuthService2, public authServiceOMS: AuthService, private dataService: DataServiceOMS,
    ...
    this.virtualTrade = AppConstants.VIRTUAL_TRADE_TYPE;
