...
import { EtfOrderCancel } from '../etf-order-cancel/etf-order-cancel';
...
export class CancelOrderAll implements OnInit, AfterViewInit {
    ...
    @ViewChild(EtfOrderCancel) cancelOrderETFs : EtfOrderCancel;
   ...
   public getOrderNoETFs(orderNo, user: string = AppConstants.username)
   {
           ...
           this.cancelOrderETFs.loadOrderNo(orderNo , user);
   }
