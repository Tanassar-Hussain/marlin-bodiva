import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, Input, OnInit, SimpleChanges, ViewChild, ViewEncapsulation } from '@angular/core';
...
export class NewOrderAll implements OnInit, AfterViewInit {
   ...
   @Input() modalId : string;
    ...
    @ViewChild('newOrderETF') OrderNewETF : OrderNewETF;

    @ViewChild('newEquity') newEquity :ElementRef;
    @ViewChild('newBonds') newBonds: ElementRef;
    @ViewChild('newETF') newETF: ElementRef;
   ...
   loggedInUserType: string;
    ...
    public clickEquityTab=()=>{
      setTimeout(() => {
       let inputElement: HTMLElement = this.newEquity.nativeElement as HTMLElement;
       inputElement.click();
     ...
     public clickBondsTab=()=>{
      ...
      setTimeout(() => {
       let inputElement: HTMLElement = this.newBonds.nativeElement as HTMLElement;
       inputElement.click();
     ...
     public clickETFTab=()=>{
      setTimeout(() => {
       let inputElement: HTMLElement = this.newETF.nativeElement as HTMLElement;
       inputElement.click();
