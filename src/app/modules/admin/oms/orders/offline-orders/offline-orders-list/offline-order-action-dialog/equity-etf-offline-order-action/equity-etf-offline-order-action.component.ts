...
@Component({
    selector: 'app-equity-etf-offline-order-action',
    templateUrl: './equity-etf-offline-order-action.component.html',
    styleUrls: ['./equity-etf-offline-order-action.component.scss']
})
export class EquityEtfOfflineOrderActionComponent implements OnInit, AfterViewInit, OnDestroy {
