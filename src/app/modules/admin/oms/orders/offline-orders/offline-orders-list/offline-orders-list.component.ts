...
@Component({
    selector: 'app-offline-orders-list',
    templateUrl: './offline-orders-list.component.html',
    styleUrls: ['./offline-orders-list.component.scss'],
   
})
export class OfflineOrdersListComponent implements OnInit, OnDestroy {
    ...
    OfflineOrderAction = OfflineOrderAction;
   ...
   // pendingOrders: Order[] = [];
    ...
    loadOrders(){
        ...
        if (this.filterForm.valid){
            setTimeout(() => {
                this._fetchOfflineOrders(this.filterForm.value);
            }, 1000);
        }
    }
    ...
    private _fetchOfflineOrders(formFilters: any){
