...
@Component({
    selector: 'app-bond-pending-order-action',
    templateUrl: './bond-pending-order-action.component.html',
    styleUrls: ['./bond-pending-order-action.component.scss']
})
export class BondPendingOrderActionComponent implements OnInit, AfterViewInit, OnDestroy {
