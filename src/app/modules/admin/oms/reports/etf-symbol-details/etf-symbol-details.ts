...
@Component({
  selector: 'etf-symbol-details',
  templateUrl: './etf-symbol-details.html',
  encapsulation: ViewEncapsulation.None,
})

export class EtfSymbolDetails {
...
public getSecurityMarket = (event) => {
  ...
  updateMarketData(markets) {
    ...
    for (let i = 0; i < markets.length; i++) {
      if ((markets[i].marketType.description === AppConstants.MARKET_TYPE_ETF_) ) {
