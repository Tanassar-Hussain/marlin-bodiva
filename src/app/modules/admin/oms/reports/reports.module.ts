...
import { ETFsWorkingOrders } from './etf-working-orders/etf-working-orders';
import { ETFsExecutedOrders } from './etf-executed-orders/etf-executed-orders';
import { ETFsEventLog } from './etf-event-logs/etf-event-logs';
import { EtfSymbolDetails } from './etf-symbol-details/etf-symbol-details';
import { SubscriptionDetails } from './subscription-details/subscription-details';
import { ExecutedOrdersHist } from './executed-orders/executed-orders-hist';
import { MarketWatchCommodities } from './market-watch-commodities/market-watch-commodities';
...
import { RejectedOrdersListComponent } from './rejected-orders/rejected-orders-list/rejected-orders-list.component';
export const routes = [
    ...
    { path : 'executed-orders-hist' , component : ExecutedOrdersHist},
    ...
    { path : 'subscription-details' , component :  SubscriptionDetails},
    { path : 'market-watch-commodities' , component :  MarketWatchCommodities},
...
@NgModule({
  ...
  declarations: [
    ...
    ETFsEventLog,
    SubscriptionDetails,
    MarketWatchCommodities,
    RejectedOrdersComponent,
    RejectedOrdersListComponent
 ],
  exports: [
    MarketSummary,
    MarketState,
