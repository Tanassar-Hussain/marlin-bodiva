...
export class WorkingOrders implements OnInit, AfterViewInit {
   ...
   public updateWorkingOrders(workingOrders): void {
    ...
    updateMarketData(markets) {
        ...
        for (let i = 0; i < markets.length; i++) {
            ...
            markets[i].marketType.description.toUpperCase() === AppConstants.MARKET_TYPE_GAX ||
            markets[i].marketType.description.toUpperCase() === AppConstants.MARKET_TYPE_ODD ||
