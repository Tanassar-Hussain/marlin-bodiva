...
export class ListingService {
  constructor(private appUtility: AppUtility, private appCons: AppConstants, private http: HttpClient,
    private authService: AuthService2, private restService: RestService) { }
  urlString: string;
  ...
  getRejectedOrder(filters: any){
    return this.restService.post(true, 'orders/rejected-orders', filters);
}

  public getSubscriptionByParticipant = (participantId: Number) => {
    this.urlString = `participants/subscription/` + participantId;
    return this.restService.get(true, this.urlString);
  }


  public deleteLeviesDetailById = (detailId: Number) => {
    this.urlString = `levies/levies-detail/delete/detailid/` + detailId;
    return this.restService.delete(true, this.urlString);
  }



  public getSubscriptionRecordByID = (subScriptionId: Number, billingId: Number) => {
    this.urlString = `product/subscription/pricing/` + subScriptionId + "/" + billingId;
    return this.restService.get(true, this.urlString);
  }



  public getParticipantLogo(participantId: Number): Observable<any> {
    this.urlString = `participants/logo/` + participantId;
    return this.restService.get(true, this.urlString);
  }



  public getSubsriptionsType(): Observable<any> {
    this.urlString = `subscription`;
    return this.restService.get(true, this.urlString);
  }


  public getSubscriptionsBilling(): Observable<any> {
    this.urlString = `subscription/billing`;
    return this.restService.get(true, this.urlString);
  }


  public getSubscriptionItemsById(id: Number): Observable<any> {
    this.urlString = `subscription/items/` + id;
    return this.restService.get(true, this.urlString);
  }



  public saveSubscriptionPricing(data: SubscriptionPricing): any {
    this.urlString = 'product/subscription/pricing';
    return this.restService.post(true, this.urlString, data);
  }


  public getSubscriptionPricingList(): any {
    this.urlString = 'product/subscription/pricing';
    return this.restService.get(true, this.urlString);
  }


  public changeSubscriptionPricing(data: SubscriptionPricing): any {
    this.urlString = 'product/subscription/pricing';
    return this.restService.put(true, this.urlString, data);
  }


  public saveSubscriptionPayment(data: SubscriptionPayment): any {
    this.urlString = 'subscription/payment';
    return this.restService.post(true, this.urlString, data);
  }


  public changeSubscriptionPayment(data: SubscriptionPayment): any {
    this.urlString = 'subscription/payment';
    return this.restService.put(true, this.urlString, data);
  }


  public getSubscriptionPaymentList(): any {
    this.urlString = 'subscription/payment/';
    return this.restService.get(true, this.urlString);
  }

  public getSubscriptionPaymentByParticipant(participantId: Number): any {
    this.urlString = 'subscription/payment/participant/' + participantId;
    return this.restService.get(true, this.urlString);
  }


  public getBondNature(): Observable<any> {
    this.urlString = `lookups/bondNature/1`;
    return this.restService.get(true, this.urlString);
  }

  public getLevyCategories(): Observable<any> {
    this.urlString = `levies/levy-categories/1`;
    return this.restService.get(true, this.urlString);
  }

  public getAssetClass(): Observable<any> {
    this.urlString = 'asset-class/';
    return this.restService.get(true, this.urlString);
  }

  public getSecuritiesByAssetClass(exchangeId: number, assetId: number): Observable<any> {
    this.urlString = `securities/allSecurities/exchange/${exchangeId}/assetClass/${assetId}`;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getActualPortfolioSummary(clientId: Number): Observable<any> {
    this.urlString = `transactions/portfolio-sum/client/` + clientId;
    return this.restService.get(true, this.urlString);
  }


  public getActualPortfolioDetail(assetId: Number, clientId: Number, transDate: String): Observable<any> {
    this.urlString = '/transactions/portfolio-det/asset/' + assetId + '/client/' + clientId + '/transDate/' + transDate;
    return this.restService.get(true, this.urlString);
  }

  public getVirtualPortfolioSummary(userId: Number): Observable<any> {
    this.urlString = `/transactions/virtual-portfolio-sum/user/${userId}`
    return this.restService.get(true, this.urlString);
  }


  public getVirtualPortfolioDetail(assetId: Number, userId: Number, transDate: String): Observable<any> {
    this.urlString = '/transactions/virtual-portfolio-det/asset/' + assetId + '/user/' + userId + '/transDate/' + transDate;
    return this.restService.get(true, this.urlString);
  }

  public getUsersByParticipant(participantId: Number): Observable<any> {
  ...
  public invCDCRegister(data: any): Observable<any[]> {
    this.urlString = 'inv-clients/cdc-register/';
    return this.restService.post(true, this.urlString, data);
  }
  ...
  public getInvestorCDCStatusesForClients(data: any): Observable<Object[]> {
   ...
   public getSettlementMembersFromCDS(participantCode : any): Observable<Object[]> {
    this.urlString = `inv-clients/settlement-members/participantcode/${participantCode}`;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getCouponPaymentDetailNew(data): any {
    this.urlString = 'bondPayments/coupons-new/';
    return this.restService.post(true, this.urlString, data);
  }

  public generateCouponPayment(data): any {
    this.urlString = 'clients/coupon-payment-gen';
    return this.restService.post(true, this.urlString, data);
  }

  public reverseCouponPayment(data): any {
    this.urlString = 'clients/coupon-payment-rollback';
    return this.restService.post(true, this.urlString, data);
  }



  public getCouponPaymentDetailNewRefresh(data): any {
    this.urlString = 'clients/coupon-payment';
    return this.restService.post(true, this.urlString, data);
  }
  ...
  public getRedemptionPaymentListNew(data): any {
    this.urlString = 'bondPayments/redemption-new/';
    return this.restService.post(true, this.urlString, data);
  }

  public getRedemptionPaymentListNewRefresh(data): any {
    this.urlString = 'clients/coupon-redemption';
    return this.restService.post(true, this.urlString, data);
  }
  ...
  public getClientIdByUserId(userId: Number): Observable<Object[]> {
    this.urlString = 'clients/client-userid/' + userId;
    return this.appUtility.wsGetRequest(this.urlString);
  }
  ...
  // /transactions/repo/startDate/{startDate}/endDate/{endDate}/participant/{participantId}/account/{account}/symbol/{symbol}

  public getRepoTradeReport(startDate: String, endDate: String, participantId : Number, account : String, symbol : string): Observable<Object[]> {
    this.urlString = 'transactions/repo/startDate/' + startDate + '/endDate/' + endDate + '/participant/' + participantId + '/account/' + account + '/symbol/' + symbol;
    return this.restService.get(true, this.urlString);
  }
  ...
  public saveSystemConfig(secdet: SystemConfig): any {
    return this.restService.post(true, 'system-config-params/', secdet);
  }

  public getSystemConfig(): any {
    return this.restService.get(true, 'system-config-params/');
  }
  ...
  public getSecurityListByAssetClass(assetId): Observable<Object[]> {
    this.urlString = 'securities/allSecuritiesWStats/assetClass/' + assetId;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getClientListByExchangeBrokerShort(exchagneId: Number, brokerId: Number, status: Boolean, orderBy: boolean = true): Observable<Object[]> {
    this.urlString = "participants/" + brokerId + "/exchanges/" + exchagneId + "/clients/" + status + "/asc/" + orderBy + "/short";
    return this.appUtility.wsGetRequest(this.urlString);
  }
  ...
  public getSettlementCalenderBy_ExchangeId_Status_TradeDate(participantId: Number, exchangeId: Number, tradeDate: Date, status: String): Observable<Object[]> {
    ...
    this.urlString = 'settlementCalendars/settlement-process-new/search/participantId/' + participantId + '/exchangeId/' + exchangeId + '/trade-date/' + formatted + '/status/' + status;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getAllSettlementCalendarByTradeDate(tradeDate: Date, participantId: Number): Observable<any[]> {
    let formatted = new DatePipe('en-US').transform(tradeDate, 'yyyy-MM-dd');
  ...
  public getParticipantSecurityExchanges(brokerId: number): Observable<Object[]> {
    this.urlString = 'participants/' + brokerId + '/exchange-market-securities-new/';
    return this.restService.get(true, this.urlString);
  ...
  public getSymbolMarket(exchangeId: number, marketId: number, symbolId: number): Observable<any[]> {
  ...
  public getTransactionTypeByAssetExchange(exchangeId: Number, assetId: Number): any {
    this.urlString = 'exchanges/asset/' + assetId + '/exch-id/' + exchangeId + '/transaction-types/'
    return this.restService.get(true, this.urlString);
  }
  ...
  public getInvestorListByParticipantMob(participantId: Number): Observable<Object[]> {
    this.urlString = "inv-clients/mob/participant-id/" + participantId;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getInvestorListBySearchMob(participantId: Number, investorName: any, taxNumber: any): Observable<Object[]> {
    this.urlString = "inv-clients/mob/inv-client-name/" + investorName + "/inv-client-tax/" + taxNumber + "/participant-id/" + participantId;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getClientListByBrokerMob(brkerId: Number, status: Boolean): Observable<Object[]> {
    this.urlString = "participants/mob/" + brkerId + "/clients/" + status;
    return this.restService.get(true, this.urlString);
  }


  // clients-without-user 
  public getClientListByBrokerWithoutUser(brkerId: Number): Observable<Object[]> {
    this.urlString = "participants/" + brkerId + "/clients-without-user";
    return this.restService.get(true, this.urlString);
  }
  ...
  public getClientListByBrokerAndClientCodeAndClientNameMob(brkerId: Number, clientCode: string, clientName: string): Observable<Object[]> {
    this.urlString = 'participants/mob/' + brkerId + '/search-clients/code/' + clientCode + '/name/' + clientName;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getClientListByBrokerAndClientCodeMob(brkerId: Number, clientCode: string): Observable<Object[]> {
    this.urlString = 'participants/mob/' + brkerId + '/search-clients/code/' + clientCode;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getClientListByBrokerAndClientNameMob(brkerId: Number, clientName: string): Observable<Object[]> {
    this.urlString = 'participants/mob/' + brkerId + '/search-clients/name/' + clientName;
    return this.restService.get(true, this.urlString);
  }
  ...
  public getAssetClassList(): Observable<any> {
    this.urlString = 'asset-class/';
    return this.restService.get(true, this.urlString);
  }

  public getmarketList(exchangeId): Observable<any> {
    this.urlString = "exchanges/" + exchangeId + "/markets/";
    return this.restService.get(true, this.urlString);
  }

  getMarkets(assetId: number){
    return this.restService.get(true, `markets/assetId/${assetId}`);
}



getRejectedNegotiatedDeals(filters: any){
  return this.restService.post(true, 'orders/rejected-nego-orders', filters);
}


submitClientNegOrder(data: any){
  return this.restService.post(true, `p-nego-trade/submit`, data);
}

getNegoPendingOrders(data: any){
  return this.restService.post(true, `p-nego-trade/list`, data);
}

acceptNegoPendingOrders(orderNo: number){
  return this.restService.get(true, `p-nego-trade/approve/${orderNo}`);
}

rejectNegoPendingOrders(data: any){
  return this.restService.put(true, `p-nego-trade/cancel`, data);
}

cancelNegoPendingOrders(orderNo: number){
  return this.restService.delete(true, `p-nego-trade/delete/${orderNo}`);
}
  ...
  public getClientListRpt(participantId: Number, toDate: Date, lang: String, reportFormat : String): Observable<Object[]> {
    this.urlString = null;
   // let from_Date = new DatePipe('en-US').transform(fromDate, 'yyyy-MM-dd');
    let to_Date = new DatePipe('en-US').transform(toDate, 'yyyy-MM-dd');
    this.urlString = 'reports/clients/participant/' + participantId + '/to-date/' + to_Date + '/lang/' + lang + '/'+ 'reportFormat/'+reportFormat+'/'
    return this.restService.get(true, this.urlString);
  }
  ...
  public getSubscriptionItemsList(): Observable<Object[]> {
    this.urlString = "participants/options/";
    return this.restService.get(true, this.urlString);
  }

  public saveSubscriptionItems(condet: SubscriptionItems): any {
    return this.restService.post(true, 'subscription/items/save/', condet);
  }

  public updateSubscriptionItems(condet: SubscriptionItems): any {
    return this.restService.put(true, 'subscription/items/update/', condet);
  }

  public getSubscriptionItemsBySubsId(subscriptionId: Number): Observable<Object[]> {
    this.urlString = "subscription/" + subscriptionId + "/items/";
    return this.restService.get(true, this.urlString);
  }
  ...
  public updateParticipantSubscription(subscription: any): any {
    return this.restService.put(true, 'participants/subscription', subscription);
  }
  ...
  getSecurities(exchangeId: number, marketId: number){
    return this.restService.get(true, `exchanges/${exchangeId}/markets/${marketId}/securities/1`);
}
  ...
  public topGainers(exchangeCode: string, marketCode: string, assetId: number, limit: number , historyDays : number): Observable<any[]> {
    this.urlString = "security/top-gainers-symbols/exch/" + exchangeCode + "/mkt-code/" + marketCode + "/asset/" + assetId + "/" + limit + "/hist-days/" + historyDays
    return this.appUtility.wsGetRequest(this.urlString);
  }

  public topLoosers(exchangeCode: string, marketCode: string, assetId: number, limit: number, historyDays : number): Observable<any[]> {
    this.urlString = "security/top-losers-symbols/exch/" + exchangeCode + "/mkt-code/" + marketCode + "/asset/" + assetId + "/" + limit + "/hist-days/" + historyDays
    return this.appUtility.wsGetRequest(this.urlString);
  }

  public volumeLeaders(exchangeCode: string, marketCode: string, assetId: number, limit: number , historyDays : number): Observable<any[]> {
    this.urlString = "security/top-tradedvol-symbols/exch/" + exchangeCode + "/mkt-code/" + marketCode + "/asset/" + assetId + "/" + limit + "/hist-days/" + historyDays;
    return this.appUtility.wsGetRequest(this.urlString);
  }

  // public getSecurityId(securityCode: string) {
  //   this.urlString = `/securities/code/${securityCode}`
  //   return this.appUtility.wsGetRequest(this.urlString);
  // }
  getSecurityId(securityCode: string) {
    this.urlString = `/securities/code/${securityCode}`
    return this.restService.get(true, this.urlString);
  }

  getSecurityDetailsByCode(securityCode: string) {
    this.urlString = `/security/recent/best-market/symbols/${securityCode}`
    return this.restService.get(true, this.urlString);
  }

  getWelcomeMsgsByPrticipant(participantID: number) {
    this.urlString = `participant-welcome-msg/${participantID}`
    return this.restService.get(true, this.urlString);
  }

  getWelcomeMsgByUserId(userId: number, languageId: string) {
    this.urlString = `participant-welcome-msg/msg/${userId}/${languageId}`
    return this.restService.get(true, this.urlString);
  }

  public saveWelcomeMsgsByPrticipant(WelcomeMsg): any {
    return this.restService.post(true, 'participant-welcome-msg/', WelcomeMsg);
  }

  public updateWelcomeMsgsByPrticipant(WelcomeMsg): any {
    return this.restService.put(true, 'participant-welcome-msg/', WelcomeMsg);
  }

  getAllTags() {
    this.urlString = `participant-welcome-msg/tags`
    return this.restService.get(true, this.urlString);
  }

  getAllParticipants() {
    this.urlString = `participants/all/`
    return this.restService.get(true, this.urlString);
  }

  getSubscriptionReport(participantId:number, subscriptionTypeId:number, fromDate:string, toDate:string){
    this.urlString = `subscription/payment/participant/${participantId}/st/${subscriptionTypeId}/${fromDate}/${toDate}`
    return this.restService.get(true, this.urlString);
  }



  getTermsAndConditionsPDF(participantId:number, langId:number){
    this.urlString = `participants/${participantId}/document/${langId}`
    return this.restService.get(true, this.urlString);
  }


saveOrderLimit(data: any){
    return this.restService.post(true, 'client/order-limit', data);
}

updateOrderLimit(data: any){
    return this.restService.put(true, 'client/order-limit', data);
}


getOrderLimits(exchangeId: number, participantId: number){
  return this.restService.get(true, `client/order-limit/list/all/exchange/${exchangeId}/participant/${participantId}`);
}


deleteOrderLimits(riskId : Number, exchangeId: Number, participantId : Number): Observable<Object[]> {
  this.urlString = 'client/order-limit/delete/riskId/' + riskId + '/exchangeId/' + exchangeId + '/participantId/' + participantId;
  return this.restService.get(true, this.urlString);
}


public getClientList(): Observable<any> {
  this.urlString = "clients/user-client/list";
  return this.appUtility.wsGetRequest(this.urlString);
}
