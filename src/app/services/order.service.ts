...
import { ExecutedOrdersSearch } from '../models/executed-orders-search';
...
export class OrderService
{
  ...
  public getExecutedOrdersReport(ordersSearchBO: ExecutedOrdersSearch): any
  {
    let url = AppConstants.apiBaseUrl + 'user-trades/';

    let Httpheaders = new HttpHeaders();    
    Httpheaders = Httpheaders.append('Authorization', 'Bearer ' + this.authService.token);

    return this.http.post(url, ordersSearchBO, { headers: Httpheaders });
  }
