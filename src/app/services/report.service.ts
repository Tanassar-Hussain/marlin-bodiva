...
export class ReportService {
    ...
    public getTradeConfirmation(participantId, marketId, transctionType, startDate, endDate, exchangeId, fromAccount, toAccount, lang): any {
        let url = 'reports/trade-confirmation/participant/' + participantId + '/market/' + marketId + '/trans-type/' + transctionType + '/from-account/' + fromAccount + '/to-account/' + toAccount
    ...
    public getClientsCashBalanceReport(PID_: number, client_: number, balance_: string, exchangeId, exchangeName, fromAccount, toAccount, startDate, branchId, branch, agentId, agent, reportType, lang): Observable<Object[]> {
        let url = 'reports/clients-cash-balance/participant/' + PID_ + '/balance/' +
            ...
            exchangeName + '/from-client/' + fromAccount + '/to-client/' + toAccount + '/from-date/' + startDate + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/agent-id/' + agentId + '/agent/' + agent + '/report-type/' + reportType + '/lang/' + lang + '/';
        return this.restService.get(true, url);
    }
    ...
    public getAccountHolding(participantId, startDate, endDate, exchangeId, exchange, assetClass, marketId, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent, lang): any {
        let url = 'reports/account-holding-summary/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange + '/assetClass/' + assetClass + '/market/' + marketId
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch)  + '/security-id/' + securityId + '/security/' + security + '/agent-id/' + agentId + '/agent/' + agent + '/lang/' + lang + '/'
        return this.restService.get(true, url);
    }

    public getAccountHoldingFormat1(participantId, startDate, endDate, exchangeId, exchange, assetClass, marketId, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent, mail, lang): any {
        let url = 'reports/account-holding-summary-format1/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange + '/assetClass/' + assetClass + '/market/' + marketId
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/agent-id/' + agentId + '/agent/' + agent + '/mail/' + mail + '/lang/' + lang + '/'
        return this.restService.get(true, url);
    }


    public getAccountHoldingFormat2(participantId, startDate, endDate, exchangeId, exchange, assetClass, marketId, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent, mail, lang): any {
    ...
    public getClientAgingCredit(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount): any {
        let url = 'reports/client-aging-credit/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            ...
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/';
        return this.restService.get(true, url);
    }
    ...
    public getAccountMarginDetail(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, closePriceDate, agentId, agent, active, reportType, lang): any {
        let url = 'reports/account-margin-detail/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/closing-price-date/' + closePriceDate + '/agent-id/' + agentId + '/agent/' + agent + '/active/' + active + '/reportType/' + reportType + '/lang/' + lang + '/';
        return this.restService.get(true, url);
    }
    ...
    public getShareHoldingClientWise(participantId, startDate, endDate, tradeDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, closePriceDate, netHolding, reportFormat, lang): any {
        let url = 'reports/share-holding-client-wise/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            ...
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/closing-price-date/' + closePriceDate + '/net-holding-type/' + netHolding + '/report-format/' + reportFormat + '/lang/' + lang + '/';
        return this.restService.get(true, url);
    }
    ...
    public getClientLastActivityWithEmail(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, agentId, agent, lang): any {
    ...
    public getSecurityWiseClientActivityDetailWithEmail(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, volume, agentId, agent, transTypeId, transType, lang): any {
        let url = 'email/securitywise-client-activity-detail/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/agent-id/' + agentId + '/agent/' + agent + '/transType-id/' + transTypeId + '/transType/' + transType + '/lang/' + lang + '/';
        return this.restService.get(true, url);
    }
    public getAccountActivitySummary(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, volume, lang): any {
        let url = 'reports/account-activity-summary/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/lang/' + lang + '/'
        return this.restService.get(true, url);
    }
    ...
    public getAccountActivityDetail(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, volume, lang): any {
        let url = 'reports/account-activity-detail/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/quantity/' + volume + '/lang/' + lang + '/';
        return this.restService.get(true, url);
    }
    ...
    public getAccountActivityDetailwithSMS(participantId, startDate, endDate, exchangeId, exchange, branchId, branch, fromAccount, toAccount, securityId, security, volume): any {
        let url = 'sms/account-activity-detail/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            + '/start-date/' + startDate + '/end-date/' + endDate + '/exchange-id/' + exchangeId + '/exchange/' + exchange
            + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(branch) + '/security-id/' + securityId + '/security/' + security + '/quantity/' + volume;
        return this.restService.get(true, url);
    }
    ...
    public getClientLevies(participantId, startDate, endDate, exchangeId, branchId, fromAccount, toAccount, leviesMasterId, exchange, participantBranch, participantLevy, lang): any {
        let url = 'reports/client-levies-detail/participant/' + participantId + '/from-account/' + fromAccount + '/to-account/' + toAccount
            ...
            + '/exchange-id/' + exchangeId + '/exchange/' + exchange + '/branch-id/' + branchId + '/participant-branch/' + encodeURIComponent(participantBranch) + '/participant-levy/' + participantLevy + '/levies-master-id/' + leviesMasterId + '/lang/' + lang + '/';
    ...
    public accountBalanceRpt(exchangeId, participantId: any, asOnDate: any, fromAcc: any, toAcc: any, securityId: any, LANG: string, format : string): any {
        let url = `reports/accountBalance/exchange/${exchangeId}/participant/${participantId}/asOnDate/${asOnDate}/from/${fromAcc}/to/${toAcc}/security/${securityId}/lang/${LANG}/format/${format}`
        return this.restService.get(true, url);
    }
}
